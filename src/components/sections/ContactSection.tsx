...
export default function ContactSection({ settings }: Props) {
  ...
  const links = [
    ...
    settings?.whatsapp && { href: `https://wa.me/${settings.whatsapp.replace(/[^0-9]/g, '')}`, label: 'WhatsApp', icon: 'message', type: 'whatsapp', external: true },
    ...
    settings?.discord_username && { href: `https://discord.com/users/${settings.discord_username}`, label: settings.discord_username, icon: 'discord', type: 'discord', external: true },
        ...
        <div className="contact-grid">
          {links.map(link => (
            ...
            >
              ...
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="14" height="14" className="contact-card-arrow">
