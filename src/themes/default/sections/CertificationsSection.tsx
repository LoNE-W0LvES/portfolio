...
export default function CertificationsSection({ settings }: { settings: PortfolioSettings }) {
  ...
  return <section id="certifications" className="section certifications-section"><div className="section-inner"><h2 className="section-title">{tr(settings.preferred_language,'certifications')}</h2><div className="timeline">
